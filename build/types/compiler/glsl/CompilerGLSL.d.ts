...
export declare class CompilerGLSL extends Compiler {
    ...
    protected emit_trinary_func_op_bitextract(result_type: number, result_id: number, op0: number, op1: number, op2: number, op: string, expected_result_type: SPIRBaseType, input_type0: SPIRBaseType, input_type1: SPIRBaseType, input_type2: SPIRBaseType): void;
    protected emit_bitfield_insert_op(result_type: number, result_id: number, op0: number, op1: number, op2: number, op3: number, op: string, offset_count_type: SPIRBaseType): void;
    ...
    protected emit_unrolled_binary_op(result_type: number, result_id: number, op0: number, op1: number, op: string, negate: boolean, expected_type: SPIRBaseType): void;
    protected emit_unary_func_op_cast(result_type: number, result_id: number, op0: number, op: string, input_type: SPIRBaseType, expected_result_type: SPIRBaseType): void;
    protected emit_binary_func_op_cast(result_type: number, result_id: number, op0: number, op1: number, op: string, input_type: SPIRBaseType, skip_cast_if_equal_type: boolean): void;
    protected emit_trinary_func_op_cast(result_type: number, result_id: number, op0: number, op1: number, op2: number, op: string, input_type: SPIRBaseType): void;
    protected emit_binary_op_cast(result_type: number, result_id: number, op0: number, op1: number, op: string, input_type: SPIRBaseType, skip_cast_if_equal_type: boolean): void;
    protected binary_op_bitcast_helper(props: {
        cast_op0: string;
        cast_op1: string;
        input_type: SPIRBaseType;
